...
public class SocketHandler : MonoBehaviour
{
    ...
    void SetupSocketIO()
    {
        ...
        SocketEventListeners.Add(new SocketEventListener("item_gain", OnItemGain));
    ...
    public void OnLevelUp(string eventName, JSONNode data)
    {
        ...
        {
            int newSpellPosition = actorDat.level - 2 + CORE.Instance.Data.content.AbilitiesInitCount - actorDat.ClassJobReference.UnlockLevel;
    ...
    public void OnItemGain(string eventName, JSONNode data)
    {
