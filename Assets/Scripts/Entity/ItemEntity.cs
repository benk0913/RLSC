...
public class ItemEntity : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (NearbyActor != null && (MultiplatformUIManager.IsUniversalPickUp || Input.GetKey(InputMap.Map["Pick Up Item"])  || Input.GetButtonDown("Joystick 0")) && NearbyActor.CanLookAround)
        {
            Interact();
        }
    }
