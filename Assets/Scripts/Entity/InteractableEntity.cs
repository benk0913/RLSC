...
public class InteractableEntity : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        bool KeyIsDown = Item? (Input.GetKeyDown(InputMap.Map["Pick Up Item"]) || Input.GetButtonDown("Joystick 6")) :  (Input.GetKeyDown(InputMap.Map["Interact"]) || Input.GetButtonDown("Joystick 2"));
