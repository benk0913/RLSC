...
public class ALIyerEdonAssets_Lighting : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        Texture2D border = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/border.psd") as Texture2D;
        Texture2D ad1 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad1.psd") as Texture2D;
        Texture2D ad2 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad2.psd") as Texture2D;
        Texture2D ad3 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad3.psd") as Texture2D;
        Texture2D ad4 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad4.psd") as Texture2D;
        Texture2D ad5 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad5.psd") as Texture2D;
        Texture2D ad6 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad6.psd") as Texture2D;
        Texture2D ad7 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad7.psd") as Texture2D;
        Texture2D ad8 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad8.psd") as Texture2D;
        Texture2D ad9 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad9.psd") as Texture2D;
        Texture2D ad10 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad10.psd") as Texture2D;
        Texture2D ad11 = EditorGUIUtility.Load("Assets/Fast Downloader/Textures/UI/Ads/ad11.psd") as Texture2D;
...
public class Startup
{
    static Startup()
    {
        EditorPrefs.SetInt("showCounts_fd", EditorPrefs.GetInt("showCounts_fd") + 1);
        if (EditorPrefs.GetInt("showCounts_fd") < 2)
        { 
            EditorApplication.ExecuteMenuItem("Window/Lighting Tools");
        }
        else   
        {
            if(EditorPrefs.GetInt("showCounts_fd") >= 30)
               EditorPrefs.SetInt("showCounts_fd", 0);
        }            
    }
}
